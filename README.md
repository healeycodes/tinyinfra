...
- POST /kv/set `{"key": "some_key", "value": "some_value", "ttl": 1671543399714}` (`ttl` is optional)
- GET /kv/get `{"key": "some_key"}` (returns `key`, `value`, `ttl`)
  
- POST /queue/send `{"namespace": "some_namespace", "message": "some_message"}`
- GET /queue/receive `{"namespace": "some_namespace", "visibilityTimeout": 20000}` (returns `namespace`, `message`, `id`)
